...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles DTO Validation Failures (e.g., @NotBlank, @Min, @Pattern)
     * Maps field names directly to their specific custom validation messages.
     */
    ...
    public ResponseEntity<ErrorResponseDto> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        ErrorResponseDto errorPayload = new ErrorResponseDto(
                ...
                "Validation failed for incoming request payload.",
                errors
        );
    ...
    /**
     * Handles State Conflicts (e.g., "Parking lot is full", "Vehicle already checked in")
     */
